...
const UpcomingEvent = () => {
  return (
    ...
    <section className='upcoming_event_section bg-third py-14'>
        <div className="upcoming_event_content max-w-[900px] xl:max-w-[1200px] mx-auto py-10">
