    ...
    <section className='upcoming_event_section bg-third py-5'>
        <div className="upcoming_event_content max-w-[1200px] mx-auto py-10">
            <div className="text-center mb-10">
               <h1 className='text-white bg-primary inline font-bold uppercase text-[20px] px-5 py-2 rounded-md'>Upcoming Event</h1>
            </div>
        <div className="flex gap-3">
         <div className="upcoming-left flex-1 h-[550px] text-center">
            <img className='h-full w-3/4 rounded-lg inline-block mx-auto' src="https://moroccomicrosoftcommunity.com/img/microsoft/Microsoft-tech-day-2024-1/big.jpg" alt="#" />
         </div>
         <div className="upcoming-right flex-1 flex flex-col justify-between text-white text-center">
            ...
            <h3 className='text-[20px] capitalize font-normal mt-7 bg-secondary inline-block px-4 py-2 rounded-md text-black'>Ensa beni mellal</h3>
            ...
            <div className="count-down w-full px-5 py-3 bg-third mt-7 rounded-lg flex justify-between items-center">
                 <div className="days flex flex-col gap-2 p-3 rounded-lg bg-secondary w-[100px] text-[20px] font-bold">
                    <span>15</span>
                    <span>Day</span>
                  </div>
                 <div className="hours flex flex-col gap-2 p-3 rounded-lg bg-secondary w-[100px] text-[20px] font-bold">
                    <span>08</span>
                    <span>Hours</span>
                  </div>
                 <div className="minutes flex flex-col gap-2 p-3 rounded-lg bg-secondary w-[100px] text-[20px] font-bold">
                    <span>58</span>
                    <span>Minutes</span>
                  </div>
                 <div className="seconds flex flex-col gap-2 p-3 rounded-lg bg-secondary w-[100px] text-[20px] font-bold">
                    <span>19</span>
                    <span>Seconds</span>
                  </div>
            </div>
